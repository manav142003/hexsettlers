...
const Dice = ({ rolling, number }) => {
  ...
  return <div className="w-24 h-24 rounded-lg bg-white border-4 border-gray-300 flex items-center justify-center text-4xl font-bold shadow-md">{rolling ? shuffleNumber : number}</div>;
};
  ...
  return (
    <div className="modal">
      ...
      <div className="modal-content">
        <h2 className="text-center p-4 text-2xl font-bold">It's your turn, username!</h2>
